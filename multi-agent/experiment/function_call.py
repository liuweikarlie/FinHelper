...
Action Input: the input to the action (if you need to run the function, please run it)
...
task = (
    "Use the 'get_stock_price' function to retrieve price data for MSFT."
    ...
    "Finally,Include the stock price, and write your analysis for stock price and store the writing in report.md by using the 'save_markdown_report'function."
)
